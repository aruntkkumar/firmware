...
#define CTLC_SW2_TRIS               TRISC3
#define CTLC_SW2_LAT                LATC3
#define CTLC_SW2_PORT               PORTCbits.RC3
#define CTLC_SW2_ANS                ANSC3
#define CTLC_SW2_SetHigh()    do { LATC3 = 1; } while(0)
#define CTLC_SW2_SetLow()   do { LATC3 = 0; } while(0)
#define CTLC_SW2_Toggle()   do { LATC3 = ~LATC3; } while(0)
#define CTLC_SW2_GetValue()         PORTCbits.RC3
#define CTLC_SW2_SetDigitalInput()    do { TRISC3 = 1; } while(0)
#define CTLC_SW2_SetDigitalOutput()   do { TRISC3 = 0; } while(0)

#define CTLC_SW2_SetAnalogMode()   do { ANSC3 = 1; } while(0)
#define CTLC_SW2_SetDigitalMode()   do { ANSC3 = 0; } while(0)
