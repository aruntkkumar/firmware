...
#define CTLC_SW1_TRIS               TRISA2
#define CTLC_SW1_LAT                LATA2
#define CTLC_SW1_PORT               RA2
#define CTLC_SW1_ANS                ANSA2
#define CTLC_SW1_SetHigh()    do { LATA2 = 1; } while(0)
#define CTLC_SW1_SetLow()   do { LATA2 = 0; } while(0)
#define CTLC_SW1_Toggle()   do { LATA2 = ~LATA2; } while(0)
#define CTLC_SW1_GetValue()         RA2
#define CTLC_SW1_SetDigitalInput()    do { TRISA2 = 1; } while(0)
#define CTLC_SW1_SetDigitalOutput()   do { TRISA2 = 0; } while(0)

#define CTLC_SW1_SetAnalogMode()   do { ANSA2 = 1; } while(0)
#define CTLC_SW1_SetDigitalMode()   do { ANSA2 = 0; } while(0)
// get/set CTLA_SW1 aliases
#define CTLA_SW1_TRIS               TRISA4
#define CTLA_SW1_LAT                LATA4
#define CTLA_SW1_PORT               RA4
#define CTLA_SW1_ANS                ANSA4
#define CTLA_SW1_SetHigh()    do { LATA4 = 1; } while(0)
#define CTLA_SW1_SetLow()   do { LATA4 = 0; } while(0)
#define CTLA_SW1_Toggle()   do { LATA4 = ~LATA4; } while(0)
#define CTLA_SW1_GetValue()         RA4
#define CTLA_SW1_SetDigitalInput()    do { TRISA4 = 1; } while(0)
#define CTLA_SW1_SetDigitalOutput()   do { TRISA4 = 0; } while(0)

#define CTLA_SW1_SetAnalogMode()   do { ANSA4 = 1; } while(0)
#define CTLA_SW1_SetDigitalMode()   do { ANSA4 = 0; } while(0)
// get/set SDATA_MIPI aliases
#define SDATA_MIPI_TRIS               TRISB4
#define SDATA_MIPI_LAT                LATB4
#define SDATA_MIPI_PORT               RB4
#define SDATA_MIPI_ANS                ANSB4
#define SDATA_MIPI_SetHigh()    do { LATB4 = 1; } while(0)
#define SDATA_MIPI_SetLow()   do { LATB4 = 0; } while(0)
#define SDATA_MIPI_Toggle()   do { LATB4 = ~LATB4; } while(0)
#define SDATA_MIPI_GetValue()         RB4
#define SDATA_MIPI_SetDigitalInput()    do { TRISB4 = 1; } while(0)
#define SDATA_MIPI_SetDigitalOutput()   do { TRISB4 = 0; } while(0)

#define SDATA_MIPI_SetAnalogMode()   do { ANSB4 = 1; } while(0)
#define SDATA_MIPI_SetDigitalMode()   do { ANSB4 = 0; } while(0)
// get/set SCLK_MIPI aliases
#define SCLK_MIPI_TRIS               TRISB5
#define SCLK_MIPI_LAT                LATB5
#define SCLK_MIPI_PORT               RB5
#define SCLK_MIPI_ANS                ANSB5
#define SCLK_MIPI_SetHigh()    do { LATB5 = 1; } while(0)
#define SCLK_MIPI_SetLow()   do { LATB5 = 0; } while(0)
#define SCLK_MIPI_Toggle()   do { LATB5 = ~LATB5; } while(0)
#define SCLK_MIPI_GetValue()         RB5
#define SCLK_MIPI_SetDigitalInput()    do { TRISB5 = 1; } while(0)
#define SCLK_MIPI_SetDigitalOutput()   do { TRISB5 = 0; } while(0)

#define SCLK_MIPI_SetAnalogMode()   do { ANSB5 = 1; } while(0)
#define SCLK_MIPI_SetDigitalMode()   do { ANSB5 = 0; } while(0)
// get/set CTLB_SW1 aliases
#define CTLB_SW1_TRIS               TRISB7
#define CTLB_SW1_LAT                LATB7
#define CTLB_SW1_PORT               RB7
#define CTLB_SW1_WPU                WPUB7
#define CTLB_SW1_SetHigh()    do { LATB7 = 1; } while(0)
#define CTLB_SW1_SetLow()   do { LATB7 = 0; } while(0)
#define CTLB_SW1_Toggle()   do { LATB7 = ~LATB7; } while(0)
#define CTLB_SW1_GetValue()         RB7
#define CTLB_SW1_SetDigitalInput()    do { TRISB7 = 1; } while(0)
#define CTLB_SW1_SetDigitalOutput()   do { TRISB7 = 0; } while(0)

#define CTLB_SW1_SetPullup()    do { WPUB7 = 1; } while(0)
#define CTLB_SW1_ResetPullup()   do { WPUB7 = 0; } while(0)
