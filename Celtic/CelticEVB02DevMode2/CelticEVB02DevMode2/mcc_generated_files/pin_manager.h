...
#define SDO1_TRIS               TRISB5
#define SDO1_LAT                LATB5
#define SDO1_PORT               RB5
#define SDO1_ANS                ANSB5
#define SDO1_SetHigh()    do { LATB5 = 1; } while(0)
#define SDO1_SetLow()   do { LATB5 = 0; } while(0)
#define SDO1_Toggle()   do { LATB5 = ~LATB5; } while(0)
#define SDO1_GetValue()         RB5
#define SDO1_SetDigitalInput()    do { TRISB5 = 1; } while(0)
#define SDO1_SetDigitalOutput()   do { TRISB5 = 0; } while(0)

#define SDO1_SetAnalogMode()   do { ANSB5 = 1; } while(0)
#define SDO1_SetDigitalMode()   do { ANSB5 = 0; } while(0)
// get/set SDO2 aliases
#define SDO2_TRIS               TRISB6
#define SDO2_LAT                LATB6
#define SDO2_PORT               RB6
#define SDO2_WPU                WPUB6
#define SDO2_SetHigh()    do { LATB6 = 1; } while(0)
#define SDO2_SetLow()   do { LATB6 = 0; } while(0)
#define SDO2_Toggle()   do { LATB6 = ~LATB6; } while(0)
#define SDO2_GetValue()         RB6
#define SDO2_SetDigitalInput()    do { TRISB6 = 1; } while(0)
#define SDO2_SetDigitalOutput()   do { TRISB6 = 0; } while(0)

#define SDO2_SetPullup()    do { WPUB6 = 1; } while(0)
#define SDO2_ResetPullup()   do { WPUB6 = 0; } while(0)
// get/set SCK aliases
