...
// get/set OE aliases
#define OE_TRIS               TRISA1
#define OE_LAT                LATA1
#define OE_PORT               RA1
#define OE_ANS                ANSA1
#define OE_SetHigh()    do { LATA1 = 1; } while(0)
#define OE_SetLow()   do { LATA1 = 0; } while(0)
#define OE_Toggle()   do { LATA1 = ~LATA1; } while(0)
#define OE_GetValue()         RA1
#define OE_SetDigitalInput()    do { TRISA1 = 1; } while(0)
#define OE_SetDigitalOutput()   do { TRISA1 = 0; } while(0)

#define OE_SetAnalogMode()   do { ANSA1 = 1; } while(0)
#define OE_SetDigitalMode()   do { ANSA1 = 0; } while(0)
// get/set LED1 aliases
#define LED1_TRIS               TRISA2
#define LED1_LAT                LATA2
#define LED1_PORT               RA2
...
#define LED2_PORT               RB4
#define LED2_ANS                ANSB4
#define LED2_SetHigh()    do { LATB4 = 1; } while(0)
#define LED2_SetLow()   do { LATB4 = 0; } while(0)
#define LED2_Toggle()   do { LATB4 = ~LATB4; } while(0)
#define LED2_GetValue()         RB4
#define LED2_SetDigitalInput()    do { TRISB4 = 1; } while(0)
#define LED2_SetDigitalOutput()   do { TRISB4 = 0; } while(0)

#define LED2_SetAnalogMode()   do { ANSB4 = 1; } while(0)
#define LED2_SetDigitalMode()   do { ANSB4 = 0; } while(0)
...
#define SPI_DATA_TRIS               TRISB7
#define SPI_DATA_LAT                LATB7
#define SPI_DATA_PORT               RB7
#define SPI_DATA_WPU                WPUB7
#define SPI_DATA_SetHigh()    do { LATB7 = 1; } while(0)
#define SPI_DATA_SetLow()   do { LATB7 = 0; } while(0)
#define SPI_DATA_Toggle()   do { LATB7 = ~LATB7; } while(0)
#define SPI_DATA_GetValue()         RB7
#define SPI_DATA_SetDigitalInput()    do { TRISB7 = 1; } while(0)
#define SPI_DATA_SetDigitalOutput()   do { TRISB7 = 0; } while(0)

#define SPI_DATA_SetPullup()    do { WPUB7 = 1; } while(0)
#define SPI_DATA_ResetPullup()   do { WPUB7 = 0; } while(0)
