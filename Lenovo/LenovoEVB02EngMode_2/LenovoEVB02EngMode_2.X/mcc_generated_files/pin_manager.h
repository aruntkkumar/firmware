...
// get/set SW1_CTL0 aliases
#define SW1_CTL0_TRIS               TRISA1
#define SW1_CTL0_LAT                LATA1
#define SW1_CTL0_PORT               RA1
#define SW1_CTL0_ANS                ANSA1
#define SW1_CTL0_SetHigh()    do { LATA1 = 1; } while(0)
#define SW1_CTL0_SetLow()   do { LATA1 = 0; } while(0)
#define SW1_CTL0_Toggle()   do { LATA1 = ~LATA1; } while(0)
#define SW1_CTL0_GetValue()         RA1
#define SW1_CTL0_SetDigitalInput()    do { TRISA1 = 1; } while(0)
#define SW1_CTL0_SetDigitalOutput()   do { TRISA1 = 0; } while(0)
...
#define SW1_CTL1_PORT               RA4
#define SW1_CTL1_ANS                ANSA4
#define SW1_CTL1_SetHigh()    do { LATA4 = 1; } while(0)
#define SW1_CTL1_SetLow()   do { LATA4 = 0; } while(0)
#define SW1_CTL1_Toggle()   do { LATA4 = ~LATA4; } while(0)
#define SW1_CTL1_GetValue()         RA4
#define SW1_CTL1_SetDigitalInput()    do { TRISA4 = 1; } while(0)
#define SW1_CTL1_SetDigitalOutput()   do { TRISA4 = 0; } while(0)

#define SW1_CTL1_SetAnalogMode()   do { ANSA4 = 1; } while(0)
#define SW1_CTL1_SetDigitalMode()   do { ANSA4 = 0; } while(0)
...
// get/set SW1_CTL2 aliases
#define SW1_CTL2_TRIS               TRISB4
#define SW1_CTL2_LAT                LATB4
#define SW1_CTL2_PORT               RB4
#define SW1_CTL2_ANS                ANSB4
#define SW1_CTL2_SetHigh()    do { LATB4 = 1; } while(0)
#define SW1_CTL2_SetLow()   do { LATB4 = 0; } while(0)
#define SW1_CTL2_Toggle()   do { LATB4 = ~LATB4; } while(0)
#define SW1_CTL2_GetValue()         RB4
#define SW1_CTL2_SetDigitalInput()    do { TRISB4 = 1; } while(0)
#define SW1_CTL2_SetDigitalOutput()   do { TRISB4 = 0; } while(0)

#define SW1_CTL2_SetAnalogMode()   do { ANSB4 = 1; } while(0)
#define SW1_CTL2_SetDigitalMode()   do { ANSB4 = 0; } while(0)
...
#define SDO_PORT               RB6
#define SDO_WPU                WPUB6
#define SDO_SetHigh()    do { LATB6 = 1; } while(0)
#define SDO_SetLow()   do { LATB6 = 0; } while(0)
#define SDO_Toggle()   do { LATB6 = ~LATB6; } while(0)
#define SDO_GetValue()         RB6
#define SDO_SetDigitalInput()    do { TRISB6 = 1; } while(0)
#define SDO_SetDigitalOutput()   do { TRISB6 = 0; } while(0)

#define SDO_SetPullup()    do { WPUB6 = 1; } while(0)
#define SDO_ResetPullup()   do { WPUB6 = 0; } while(0)
// get/set SCK aliases
#define SCK_TRIS               TRISB7
#define SCK_LAT                LATB7
#define SCK_PORT               RB7
#define SCK_WPU                WPUB7
#define SCK_SetHigh()    do { LATB7 = 1; } while(0)
#define SCK_SetLow()   do { LATB7 = 0; } while(0)
#define SCK_Toggle()   do { LATB7 = ~LATB7; } while(0)
#define SCK_GetValue()         RB7
#define SCK_SetDigitalInput()    do { TRISB7 = 1; } while(0)
#define SCK_SetDigitalOutput()   do { TRISB7 = 0; } while(0)

#define SCK_SetPullup()    do { WPUB7 = 1; } while(0)
#define SCK_ResetPullup()   do { WPUB7 = 0; } while(0)
