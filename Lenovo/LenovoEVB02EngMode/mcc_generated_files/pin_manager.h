...
#define SW1_CTL1_TRIS               TRISA5
#define SW1_CTL1_LAT                LATA5
#define SW1_CTL1_PORT               RA5
#define SW1_CTL1_SetHigh()    do { LATA5 = 1; } while(0)
#define SW1_CTL1_SetLow()   do { LATA5 = 0; } while(0)
#define SW1_CTL1_Toggle()   do { LATA5 = ~LATA5; } while(0)
#define SW1_CTL1_GetValue()         RA5
#define SW1_CTL1_SetDigitalInput()    do { TRISA5 = 1; } while(0)
#define SW1_CTL1_SetDigitalOutput()   do { TRISA5 = 0; } while(0)
